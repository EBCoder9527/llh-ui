<template>
  <div class="container">
    ...
    <div ref="btnRef" class="label" :class="text == '录音中'?'gif':''" id="label">
     <img v-if="text == '录音中'" src="../assets/mcf-active.png" alt=""> 
     <img v-else src="../assets/mcf-inactive.png" alt="">
     <span :style="{color:text == '录音中'?'#86628D':'#000'}">{{ text }}</span>
     <img v-if="text == '录音中'" class="img-gif" src="../assets/voice.gif" alt="">
    </div>
  </div>
</template>
<script>
